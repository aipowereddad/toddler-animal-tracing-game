 ...
 */
export function startIntermediateMode(canvas) {
    if (DEBUG_MODE) {
 ...
 */
function animateAndReplace(index) {
 ...
 */
function loadAnimalIntoSlot(index) {
    return __awaiter(this, void 0, void 0, function* () {
